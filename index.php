...
<html>
		...
		<p align = "center" style = "font-size:30px;">Подай сигнал </p>
			...
			<form action="index.php" method="post" enctype="multipart/form-data" align = "center">	
				<p>Подател</p>
				<input type = "text"placeholder = "име" name = "fname" style = "width: 19%; height:40px;"/><br>
				<input type = "text"placeholder = "фамилия" name = "lname" style = "margin-top:2px;width: 19%; height:40px;"/><br>
